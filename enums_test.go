...
func TestIDDocumentType(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:    "valid",
			args:    base.IDDocumentTypeNationalID,
			convert: base.IDDocumentTypeNationalID,
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
			},
		...
		{
			name:    "valid_no_convert",
			args:    base.IDDocumentTypePassport,
			convert: "testaddress",
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
		...
		},
		{
			name:    "valid_can_convert",
			args:    base.IDDocumentTypePassport,
			convert: base.IDDocumentTypePassport,
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
			},
...
func TestMaritalStatus(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:    "valid",
			args:    base.MaritalStatusS,
			convert: base.MaritalStatusS,
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
			},
...
func TestRelationshipType(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:    "valid",
			args:    base.RelationshipTypeF,
			convert: base.RelationshipTypeF,
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
			},
		...
		},
		{
			name:    "valid_can_convert",
			args:    base.RelationshipTypeO,
			convert: base.RelationshipTypeO,
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
			},
...
func TestIdentifierUse(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:    "valid",
			args:    base.IdentifierUseOld,
			convert: base.IdentifierUseTemp,
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
			},
...
func TestContactPointSystem(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:    "valid",
			args:    base.ContactPointSystemFax,
			convert: base.ContactPointSystemFax,
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
			},
		...
		{
			name:    "valid_no_convert",
			args:    base.ContactPointSystemEmail,
			convert: "testaddress",
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
		...
		},
		{
			name:    "valid_can_convert",
			args:    base.ContactPointSystemEmail,
			convert: base.ContactPointSystemEmail,
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
			},
...
func TestContactPointUse(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:    "valid",
			args:    base.ContactPointUseHome,
			convert: base.ContactPointUseHome,
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
			},
		...
		{
			name:    "valid_no_convert",
			args:    base.ContactPointUseMobile,
			convert: "testaddress",
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
		...
		},
		{
			name:    "valid_can_convert",
			args:    base.ContactPointUseMobile,
			convert: base.ContactPointUseMobile,
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
			},
...
func TestNameUse(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:    "valid",
			args:    base.NameUseTemp,
			convert: base.NameUseTemp,
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
			},
...
func TestEpisodeOfCareStatus(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:    "valid",
			args:    base.EpisodeOfCareStatusPlanned,
			convert: base.EpisodeOfCareStatusPlanned,
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
			},
		...
		{
			name:    "valid_no_convert",
			args:    base.EpisodeOfCareStatusActive,
			convert: "testaddress",
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
		...
		{
			name:    "valid_can_convert",
			args:    base.EpisodeOfCareStatusFinished,
			convert: base.EpisodeOfCareStatusFinished,
			expectation: expects{
				isValid:      true,
				canUnmarshal: true,
			},
